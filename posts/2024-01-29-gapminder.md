...
tags: F#, Plotly, 数据可视化, 编程, F#
---

[Gapminder](https://www.gapminder.org/) is a good topic covering world development, data analytics with good insights.

<!--more-->
I spent a Saturday afternoon to recreate a similar 互动 chart with data from world bank [](https://data.worldbank.org/), using F# and [Plotly.Net](https://Plotly.net/) gdp per capita vs. life expectancy over years, sized in populatio and colored by region. 
